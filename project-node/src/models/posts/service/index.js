...
export class PostService {
    ...
    async createPostLike(userId, postId) {
        const user = await this.memberService.findMemberById(userId);
    ...
    async createComment(props) {
        const user = await this.memberService.findMemberById(props.memberId);
    ...
    async createChildComment(props) {
        const user = await this.memberService.findMemberById(props.userId);
