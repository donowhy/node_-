...
public class MemberController {
    ...
    @PostMapping("/signup")
    public void save(@RequestBody @Valid RegisterDto registerDto){
    ...
    @GetMapping("/info/{id}")
    public MemberResponse getMemberInfo (@toyproject.todoList.global.jwt.MemberInfo MembersInfo membersInfo, @PathVariable("id") Integer id) throws Exception {
    ...
    public MemberInfo getMyInfo (@toyproject.todoList.global.jwt.MemberInfo MembersInfo membersInfo) {
    ...
    public UpdateUserResponseDto updateNickname (@toyproject.todoList.global.jwt.MemberInfo MembersInfo membersInfo, @RequestBody UpdateUserRequestDto updateUserRequestDto){
    ...
    public void delete (@toyproject.todoList.global.jwt.MemberInfo MembersInfo membersInfo){
...
//    }
    ...
    public void changeMyPassword (@toyproject.todoList.global.jwt.MemberInfo MembersInfo membersInfo, @RequestBody ChangeMyPasswordRequestDto requestDto){
    ...
    public void changePrivacy(@toyproject.todoList.global.jwt.MemberInfo MembersInfo membersInfo){
